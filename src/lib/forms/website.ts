// The website onboarding questionnaire, as data.
//
// Replaces two forms Jay was running in parallel — a Tally (tally.so/r/PdypWe)
// and a Jotform (jotform.com/form/260881765182061). This is the union of both
// plus the fields that kept getting chased by hand afterwards.
//
...
export const websiteForm = defineForm({
  kind: "website",
  schemaId: "2026-08-31",
  label: "Website",
  sections: SECTIONS,
  summaryFields: ["owner_name", "phone_mobile", "email", "home_town", "primary_services", "primary_areas"],
  quota: {
    maxObjects: 120,
    maxVideos: 6,
  ...
  copy: {
    ...
    ogTitle: "Website onboarding · Innov8 Workflows",
    ogDescription:
      "Tell us about your business and send us your photos — that's everything we need to build your website.",
    ogImage: "/og-onboarding.jpg",
    ogAlt: "Innov8 Workflows — Let's get your website started.",
    eyebrow: "Website onboarding",
    startTitle: "Let's get your website started.",
    startIntro:
    ...
    doneTitle: "Thanks — that's everything we need to get going.",
    doneBody:
