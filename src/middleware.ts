...
const PUBLIC_PATHS = ["/login", "/api/auth/login", "/api/auth/setup", "/api/webhook/gmail", "/api/webhook/prospects", "/api/webhook/client-leads", "/api/health/check", "/api/track", "/track.js"];
