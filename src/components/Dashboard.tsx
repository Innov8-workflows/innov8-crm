    ...
    <div className="flex-1 overflow-auto p-6 space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4">
          ...
          <RevenueCard label="Client ARR" value={`\u00A3${((clients?.mrr || 0) * 12).toFixed(2)}`} color="#facc15"
          ...
          <RevenueCard label="Total ARR (incl. upsells)" value={`\u00A3${(((clients?.mrr || 0) + (solutions?.mrr || 0)) * 12).toFixed(2)}`} color="#22c55e"
