...
const TABS = ["All", "Plumbing", "Electrician", "Driveway", "Builder", "Roofer", "Scaffolder", "Beauty", "Hairdresser", "Dog Groomer", "Personal Trainer", "Photographer", "LinkedIn SME", "Other"];
...
export default function LeadGrid({ ownerFilter = "" }: { ownerFilter?: string }) {
  ...
  const getAutoStage = useCallback((leadId: number, overrideField?: string, overrideValue?: number | string) => {
    ...
    if (["to_call", "meeting_booked", "verbal", "maybe", "ice", "won", "lost", "rejected", "dead"].includes(s)) return null;
